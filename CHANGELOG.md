...
## Unreleased
- Add `WithClientQueryTimeout` for client-side execution deadlines on both Thrift and SEA/kernel while preserving each backend's legacy contract when omitted.
