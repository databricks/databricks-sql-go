...
func TestParseConfig(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			args: args{dsn: "jim:supersecret2@example.cloud.databricks.com:443/sql/1.0/endpoints/12346a5b5b0e123a"},
			wantCfg: UserConfig{
				Protocol:      "https",
				Host:          "example.cloud.databricks.com",
				Port:          443,
			...
			wantURL: "https://jim:supersecret2@example.cloud.databricks.com:443/sql/1.0/endpoints/12346a5b5b0e123a",
			wantErr: false,
		},
		{
		...
		},
		{
			...
			args:    args{dsn: "token:supersecret2@example.cloud.databricks.com:443/sql/1.0/endpoints/12346a5b5b0e123a?catalog=default&schema=system&timeout=foo&maxRows=12"},
			wantCfg: UserConfig{},
			wantErr: true,
		},
		{
