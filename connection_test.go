...
// 	t.Run("executeStatement should return ExecuteStatementResp on success", func(t *testing.T) {
// 		var executeStatementCount int
// 		executeStatement := func(ctx context.Context, req *client.ExecuteStatementReq) (r *client.ExecuteStatementResp, err error) {
// 			executeStatementCount++
...
// 		testClient := &client.TestClient{
// 			FnExecuteStatement: executeStatement,
// 			FnCancelExecution:  cancelOperation,
// 		}
// 		testConn := &conn{
// 			session: getTestSession(),
// 			client:  testClient,
...
// 		getExecutionStatus := func(ctx context.Context, req *cli_service.TGetOperationStatusReq) (r *cli_service.TGetOperationStatusResp, err error) {
...
// 				return &cli_service.TCloseOperationResp{}, nil
// 			},
// 			FnCancelExecution: func(ctx context.Context, req *cli_service.TCancelOperationReq) (r *cli_service.TCancelOperationResp, err error) {
// 				cancelOperationCount++
// 				cancelOperationResp := &cli_service.TCancelOperationResp{
// 					Status: &cli_service.TStatus{
// 						StatusCode: cli_service.TStatusCode_SUCCESS_STATUS,
