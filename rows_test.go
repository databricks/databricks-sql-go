...
// 	// default TRowSet
// 	tRowSet := &cli_service.TRowSet{}
// 	rowSet.results.Results = tRowSet
...
// 	rowSet.results.HasMoreRows = &noMoreRows
...
// 	assert.NotNil(t, rowSet.results)
